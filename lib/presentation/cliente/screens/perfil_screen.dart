                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            if (_isEditing) {
                              // Cancelar edición
                              _nombreController.text = _usuario!['nombre']?.toString() ?? '';
                              _telefonoController.text = _usuario!['telefono']?.toString() ?? '';
                              _direccionController.text = _usuario!['direccion']?.toString() ?? '';
                            }
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              ListTile(
                                                ...
                                                subtitle: const Text('Ver todos mis pedidos'),
