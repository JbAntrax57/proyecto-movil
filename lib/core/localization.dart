...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'es': {
      ...
      // Direcciones
      'registrar_direcciones': 'Registrar direcciones',
      'gestionar_mis_direcciones': 'Gestionar mis direcciones',
      'mis_direcciones': 'Mis Direcciones',
      'agregar_direccion': 'Agregar dirección',
      'editar_direccion': 'Editar dirección',
      'nombre_direccion': 'Nombre de la dirección',
      'ingrese_nombre_direccion': 'Por favor ingresa un nombre para la dirección',
      'marcar_predeterminada': 'Marcar como predeterminada',
      'direccion_predeterminada': 'Dirección marcada como predeterminada',
      'direccion_seleccionada': 'Dirección seleccionada',
      'direccion_guardada': 'Dirección guardada correctamente',
      'direccion_actualizada': 'Dirección actualizada correctamente',
      'direccion_eliminada': 'Dirección eliminada correctamente',
      'error_guardar_direccion': 'Error al guardar dirección',
      'error_eliminar_direccion': 'Error al eliminar dirección',
      'error_marcar_predeterminada': 'Error al marcar como predeterminada',
      'confirmar_eliminar_direccion': '¿Estás seguro de que deseas eliminar la dirección',
      'no_hay_direcciones': 'No hay direcciones registradas',
      'agregar_primera_direccion': 'Agrega tu primera dirección para facilitar tus pedidos',
      'predeterminada': 'Predeterminada',

      // Traducciones adicionales faltantes
      'mis_notificaciones': 'Mis Notificaciones',
      'no_notificaciones_recientes': 'No tienes notificaciones recientes.',
      'mapa_entrega': 'Mapa de Entrega',
      'actualizar_estado_pedido': 'Actualizar Estado del Pedido',
      ...
      'detalles_cliente': 'Detalles del Cliente',
      'contactar': 'Contactar',
      'mis_puntos': 'Mis Puntos',
      'no_cargar_restaurante': 'No se pudo cargar el ID del restaurante.',
      'agregar_puntos': 'Agregar Puntos',
      'quitar_puntos': 'Quitar Puntos',
      'todos': 'Todos',
      'rol': 'Rol',
      ...
      'dueño': 'Dueño',
      'marcar_destacado': 'Marcar destacado',
      'quitar_destacado': 'Quitar destacado',
      'asignar_puntos': 'Asignar Puntos',
      'puntos_actuales': 'Puntos actuales',
      'agregar_puntos_opcion': 'Agregar puntos',
      'quitar_puntos_opcion': 'Quitar puntos',
      'confirmar_direccion': 'Confirmar Dirección',
      'confirmar_envio_direccion': '¿Estás seguro de que quieres enviar tu pedido a esta dirección?',
      'gestionar_direcciones': 'Gestionar Direcciones',
      'seleccion_requerida': 'Selección Requerida',
      'no_disponible': 'No disponible',
      'eliminar_direccion': 'Eliminar Dirección',
      'seleccionar_ubicacion': 'Selecciona tu ubicación',
      'necesitamos_ubicacion_entrega': 'Necesitamos tu ubicación para entregar tu pedido',
      'mis_direcciones_guardadas': 'Mis direcciones guardadas',
      'por_favor_selecciona_direccion': 'Por favor, selecciona una de tus direcciones guardadas para continuar.',
    },
    'en': {
      // Navigation
      'inicio': 'Home',
      ...
      // Addresses
      'registrar_direcciones': 'Register addresses',
      'gestionar_mis_direcciones': 'Manage my addresses',
      'mis_direcciones': 'My Addresses',
      'agregar_direccion': 'Add address',
      'editar_direccion': 'Edit address',
      'nombre_direccion': 'Address name',
      'ingrese_nombre_direccion': 'Please enter a name for the address',
      'marcar_predeterminada': 'Mark as default',
      'direccion_predeterminada': 'Address marked as default',
      'direccion_seleccionada': 'Address selected',
      'direccion_guardada': 'Address saved successfully',
      'direccion_actualizada': 'Address updated successfully',
      'direccion_eliminada': 'Address deleted successfully',
      'error_guardar_direccion': 'Error saving address',
      'error_eliminar_direccion': 'Error deleting address',
      'error_marcar_predeterminada': 'Error marking as default',
      'confirmar_eliminar_direccion': 'Are you sure you want to delete the address',
      'no_hay_direcciones': 'No registered addresses',
      'agregar_primera_direccion': 'Add your first address to facilitate your orders',
      'predeterminada': 'Default',

      // Additional missing translations
      'mis_notificaciones': 'My Notifications',
      'no_notificaciones_recientes': 'You have no recent notifications.',
      'mapa_entrega': 'Delivery Map',
      'actualizar_estado_pedido': 'Update Order Status',
      ...
      'detalles_cliente': 'Client Details',
      'contactar': 'Contact',
      'mis_puntos': 'My Points',
      'no_cargar_restaurante': 'Could not load restaurant ID.',
      ...
      'categoria_mas_vendida': 'Most sold category',
      'categoria_menos_vendida': 'Least sold category',
      'dueño': 'Owner',
      'marcar_destacado': 'Mark as featured',
      'quitar_destacado': 'Remove featured',
      'asignar_puntos': 'Assign Points',
      'puntos_actuales': 'Current points',
      'agregar_puntos_opcion': 'Add points',
      'quitar_puntos_opcion': 'Remove points',
      'confirmar_direccion': 'Confirm Address',
      'confirmar_envio_direccion': 'Are you sure you want to send your order to this address?',
      'gestionar_direcciones': 'Manage Addresses',
      'seleccion_requerida': 'Selection Required',
      'no_disponible': 'Not available',
      'eliminar_direccion': 'Delete Address',
      'seleccionar_ubicacion': 'Select your location',
      'necesitamos_ubicacion_entrega': 'We need your location to deliver your order',
      'mis_direcciones_guardadas': 'My saved addresses',
      'por_favor_selecciona_direccion': 'Please select one of your saved addresses to continue.',
    },
  };
